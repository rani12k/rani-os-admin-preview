const mobileResponsivePatchBuild='2026-07-04-MOBILE-009';
function applyMobileResponsivePatch(){
  const old=document.getElementById('mobile-responsive-patch-style');
  if(old) old.remove();
  ...
  @media (max-width: 820px){
    ...
    .tabs{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:7px!important;overflow:visible!important;}
    .tabs button{white-space:normal!important;min-width:0!important;border-radius:12px!important;font-size:13px!important;padding:10px 7px!important;line-height:1.2!important;}
    .kpis{grid-template-columns:repeat(2,minmax(0,1fr))!important;}
    .kpi .num{font-size:21px!important;}
    .kpi .txt{font-size:13px!important;line-height:1.25!important;}
    .filters{grid-template-columns:1fr!important;}
    .filters input,.filters select{font-size:15px!important;padding:12px 10px!important;}
    ...
    td::before{content:attr(data-label)!important;color:#9fb0c7!important;font-size:12px!important;line-height:1.25!important;overflow-wrap:anywhere!important;font-weight:600!important;}
    .badge{font-size:12px!important;padding:4px 7px!important;white-space:normal!important;line-height:1.2!important;}
    .note{font-size:14px!important;line-height:1.35!important;}
  }
  @media (max-width: 420px){
    ...
    td{grid-template-columns:96px minmax(0,1fr)!important;font-size:14.5px!important;padding:9px 6px!important;}
    td::before{font-size:11.5px!important;}
    .badge{font-size:11.5px!important;padding:3px 6px!important;}
  }`;
...
function markMobilePatchBuild(){
  ...
  if(sub && !sub.textContent.includes('MOBILE-009')) {
    sub.textContent=sub.textContent.replace(/ · Mobile Responsive Patch MOBILE-\d+/g,'');
    sub.textContent += ' · Mobile Responsive Patch MOBILE-009';
  }
}
